...
function printResults(results) {
    ...
    for (const yearAndResult of results) {
        ...
        console.log(`Total Contributions: ${yearAndResult.totalContributions.toFixed(0)}`);
        console.log(`Total Interest Earned: ${yearAndResult.totalInterestEarned.toFixed(0)}`);
        console.log('-----------------------');
    }
}
